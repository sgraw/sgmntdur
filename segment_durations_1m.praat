...
form start
	...
	sentence file_path /Volumes/KOALA/Documents/Dagestan_Stops/test_textgrids/archive/
	...
	word outputf dagstop_seg_vot3_Rutul.txt
...
...tab$, "tstart", tab$, "tend", tab$, "reltime", tab$, "pfst", tab$, "cvst", tab$, "modst", tab$, "voicingdur", tab$, "voiceperc", tab$, "comment"
...
for i to nrst
	...
	for iii to nri
		...
		li$=replace$(li$,")","",0)
		li$=replace$(li$,"(","",0)
		if (li$!="a" and li$!="i" and li$!="ai" and li$!="o" and li$!="u" and li$!="x" and li$!="i" and li$!="e" and li$!="ẽ" and li$!="r" and li$!="ɨ" and li$!="ʃ" and li$!="ʃtʃ" and li$!="š" and li$!="z" and li$!="ž"
			...
			vowelstring$=replace_regex$(word$,"gʲ|ɢ|r|c|t|ʃ|x|k|q|p|χ|s|ɬ|b|d|g|p|'|:|ː|j|m|n|l|z|f|ˤ|R|w|ʒ|h|ʁ|ʷ|с|ʔ|ʲ|X|´|’| ","",0)
			...
			...tab$, st, tab$, et, tab$, reltime, tab$, pfst, tab$, cv2st, tab$, modst, tab$, voicingdur, tab$, voiceperc, tab$, comm$

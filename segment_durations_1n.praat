...
...tab$, "affric", tab$, "glott", tab$,  "pharlzd" , tab$, "labialzd", tab$, "palatlzd" , tab$, "folVowel", tab$, "prevVowel", tab$, "worddur", tab$,"totdur", tab$, "folVowDur", tab$, "prevVowDur", tab$, "fric", tab$, "postfric", tab$, "closdur",
...
for i to nrst
	...
	for iii to nri
		...
		if (li$!="a" and li$!="i" and li$!="ai" and li$!="o" and li$!="u" and li$!="x" and li$!="i" and li$!="e" and li$!="ẽ" and li$!="r" and li$!="ɨ:" and li$!="ɨ" and li$!="ʃ" and li$!="ʃtʃ" and li$!="š" and li$!="z" and li$!="ž"
			...
			...tab$, affric$, tab$, glott$, tab$, pharlzd$, tab$, lablzd$, tab$, palatlzd$, tab$, fli$, tab$, pli$, tab$, worddur, tab$, totdur, tab$, fvdur, tab$, pvdur, tab$, f, tab$, pf, tab$, cd,
